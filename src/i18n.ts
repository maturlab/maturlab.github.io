...
export const ui = {
  tr: {
    ...
    focus: [
      ...
      ['Biyocoğrafya ve koruma', 'Endemik türlerin yayılış alanları, genetik çeşitliliği ve koruma öncelikleri.'],
    ...
    lead: 'Yürütücü',
    collaborators: 'Diğer araştırmacılar',
  ...
  en: {
    ...
    focus: [
      ...
      ['Biogeography and conservation', 'Distribution, genetic diversity and conservation priorities of endemic species.'],
