...
interests:
  ...
  en: [Magnetoreception, Biophysics, Animal behaviour, Evolutionary biology]

activities:
  - date: { tr: "Temmuz – Ağustos 2026", en: "July – August 2026" }
    title: { tr: "Erasmus+ Araştırma Stajyeri", en: "Erasmus+ Research Intern" }
    where:
      tr: "Max Planck Hayvan Davranışı Enstitüsü (MPI-AB), Kolektif Davranış İleri Araştırmalar Merkezi (CASCB)"
      en: "Max Planck Institute of Animal Behavior (MPI-AB), CASCB – Centre for the Advanced Study of Collective Behaviour"
  - date: "2025"
    title: { tr: "Poster Sunumu", en: "Poster Presentation" }
    where:
      tr: "EEBST 2025: 11. Ekoloji ve Evrimsel Biyoloji Sempozyumu"
      en: "EEBST 2025: 11th Ecology and Evolutionary Biology Symposium"
    detail: "“Magnetoreception in Birds and Mammals: A Comparative Perspective from Quantum Biology”"

# Doldurulabilecek diğer alanlar için ferhat-matur.md dosyasına bakın:
# education, experience, awards, links (orcid, scholar, researchgate, linkedin), cv
---
